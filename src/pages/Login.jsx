    ...
    <div className="bg-[#FDFBF7] min-h-screen py-16 flex items-center justify-center px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-md w-full index-card paper-tape bg-white rounded-3xl border border-stone-200 p-8 space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-serif font-extrabold text-stone-900">Welcome Back</h1>
          <p className="text-xs text-stone-500">Log in to access your enrolled courses and study schedule.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-semibold">
          ...
          >
            Log In to EduLearn <ArrowRight className="w-4 h-4" />
          </button>
        </form>
